...
export const wedding = {
  ...
  events: [
    ...
    { name: "Wedding Ceremony", date: "7 Jul 2026", time: "11:00 AM", location: "Puzhakkarakkavu Temple, Muvattupuzha" },
    { name: "Reception", date: "7 Jul 2026", time: "7:00 PM", location: "Muvattupuzha" },
  ],
  venue: {
    name: "Puzhakkarakkavu Temple",
    address: "Puzhakkarakkavu Temple, Muvattupuzha, Kerala",
    mapEmbed: "https://www.google.com/maps?q=Puzhakkarakkavu+Temple+Muvattupuzha&output=embed",
    directions: "https://maps.google.com/?q=Puzhakkarakkavu+Temple+Muvattupuzha",
  },
  family: {
    bride: {
      title: "Daughter of",
